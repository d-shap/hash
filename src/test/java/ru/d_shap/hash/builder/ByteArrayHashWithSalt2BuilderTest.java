...
public final class ByteArrayHashWithSalt2BuilderTest {
    ...
    public void isHashValidTest() {
        ...
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{9, 11, 57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 59, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92}).isHashValid()).isFalse();

        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{9, 11, 22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{9, 11, 115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{109, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, 115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{9, 11, -93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -99, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50}).isHashValid()).isFalse();

        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92, 10, 11}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92, 9, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{57, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{59, -18, 39, 38, 65, -20, 93, -36, -128, 110, 117, -30, 53, -12, -126, -92, 10, 11}).isHashValid()).isFalse();

        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52, 10, 11}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52, 9, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{22, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 6, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{29, 107, -58, 64, -113, -45, 32, -28, -29, 121, -103, -34, 119, -102, 122, -52, 10, 11}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56, 10, 11}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56, 9, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{109, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{115, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{119, 46, 121, -41, 123, -8, 72, -111, -109, 74, 20, -83, -97, 55, -82, 56, 10, 11}).isHashValid()).isFalse();

        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50, 10, 11}).isHashValid()).isTrue();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{9, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50, 9, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-93, -111, 72, -22, 99, 18, -94, 26, -46, 50, 122, -40, 12, -5, -79, 50, 10, 11}).isHashValid()).isFalse();
    ...
    public void isWrongStoredHashLengthHashValidTest() {
        try {
            new ByteArrayHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{1, 2, 3, 4, 5, 6}).isHashValid();
            Assertions.fail("ByteArrayHashWithSalt2Builder test fail");
        } catch (WrongHashArgumentException ex) {
