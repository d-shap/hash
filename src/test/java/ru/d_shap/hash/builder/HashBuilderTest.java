...
public final class HashBuilderTest {
    ...
    public void newByteArrayHashWithSaltBuilderTest() {
        ...
        Assertions.assertThat(HashBuilder.newHashWithSaltBuilder(new byte[]{1, 2, 3, 4, 5}).setAlgorithm(HashAlgorithms.MD5).setStoredSaltLenght(2).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -125, -55, 98, 99, -96, 6, -52, 4, 25, 56, -88, -22, 69, -121, -101, -23}).isHashValid()).isTrue();
    }
    ...
    public void newStringHashWithSaltBuilderTest() {
        ...
        Assertions.assertThat(HashBuilder.newHashWithSaltBuilder("12345", "UTF-8").setAlgorithm(HashAlgorithms.MD5).setStoredSaltLenght(2).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -92, -92, -91, -78, -54, 57, 120, -113, -55, -39, 59, -51, 93, 51, -127, -53}).isHashValid()).isTrue();
    }
    ...
    public void newInputStreamHashWithSaltBuilderTest() {
        ...
        Assertions.assertThat(HashBuilder.newHashWithSaltBuilder(new ByteArrayInputStream(new byte[]{1, 2, 3, 4, 5})).setAlgorithm(HashAlgorithms.MD5).setStoredSaltLenght(2).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -125, -55, 98, 99, -96, 6, -52, 4, 25, 56, -88, -22, 69, -121, -101, -23}).isHashValid()).isTrue();
    }
    ...
    public void newByteArrayHashWithSalt2BuilderTest() {
        ...
        Assertions.assertThat(HashBuilder.newHashWithSalt2Builder(new byte[]{1, 2, 3, 4, 5}).setAlgorithm(HashAlgorithms.MD5).setStoredSaltLenght(2).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setFixedSalt(new byte[]{20, 30, 40}).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setStoredHash(new byte[]{10, 11, 90, 49, 37, 101, -5, 53, 107, 124, -39, 10, -6, -123, 67, -119, 18, -71}).isHashValid()).isTrue();
    }
    ...
    public void newStringHashWithSalt2BuilderTest() {
        ...
        Assertions.assertThat(HashBuilder.newHashWithSalt2Builder("12345", "UTF-8").setAlgorithm(HashAlgorithms.MD5).setStoredSaltLenght(2).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setFixedSalt(new byte[]{20, 30, 40}).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setStoredHash(new byte[]{10, 11, 70, 73, 73, 69, 61, 71, 124, -14, -11, -84, -69, -7, -90, 59, 23, -86}).isHashValid()).isTrue();
    }
    ...
    public void newInputStreamHashWithSalt2BuilderTest() {
        ...
        Assertions.assertThat(HashBuilder.newHashWithSalt2Builder(new ByteArrayInputStream(new byte[]{1, 2, 3, 4, 5})).setAlgorithm(HashAlgorithms.MD5).setStoredSaltLenght(2).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setFixedSalt(new byte[]{20, 30, 40}).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setStoredHash(new byte[]{10, 11, 90, 49, 37, 101, -5, 53, 107, 124, -39, 10, -6, -123, 67, -119, 18, -71}).isHashValid()).isTrue();
    }
