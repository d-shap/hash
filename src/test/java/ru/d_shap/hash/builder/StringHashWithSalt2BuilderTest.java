...
public final class StringHashWithSalt2BuilderTest {
    ...
    public void getStoredSaltLenghtTest() {
        Assertions.assertThat(new StringHashWithSalt2Builder(null, null).getStoredSaltLenght()).isEqualTo(0);
        Assertions.assertThat(new StringHashWithSalt2Builder(null, null).setStoredSaltLenght(16).getStoredSaltLenght()).isEqualTo(16);
        Assertions.assertThat(new StringHashWithSalt2Builder(null, null).setStoredSaltLenght(32).getStoredSaltLenght()).isEqualTo(32);
    }
    ...
    public void isHashValidTest() {
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36}).isHashValid()).isTrue();
        Assertions.assertThat(new StringHashWithSalt2Builder("92345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{9, 11, -69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -60, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36}).isHashValid()).isFalse();

        Assertions.assertThat(new StringHashWithSalt2Builder("12365", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -7, -41, 26, 83, 111, 104, 6, 102, 8, 85, -62, -117, -115, -83, 4, -18}).isHashValid()).isTrue();
        Assertions.assertThat(new StringHashWithSalt2Builder("92365", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -7, -41, 26, 83, 111, 104, 6, 102, 8, 85, -62, -117, -115, -83, 4, -18}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -68, 111, 97, -112, 0, 111, 6, 52, 103, 72, -78, 125, -52, -94, -77, 109}).isHashValid()).isTrue();
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{109, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -68, 111, 97, -112, 0, 111, 6, 52, 103, 72, -78, 125, -52, -94, -77, 109}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -68, 111, 97, -112, 0, 111, 6, 52, 103, 72, -78, 125, -52, -94, -77, 109}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -56, -54, 43, 102, 27, -32, 7, 57, -124, -58, 61, -25, -58, 60, 18, 51}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -56, -54, 43, 102, 27, -32, 7, 57, -124, -58, 61, -25, -58, 60, 18, 51}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_BEGINNING).setStoredHash(new byte[]{10, 11, -59, -54, 43, 102, 27, -32, 7, 57, -124, -58, 61, -25, -58, 60, 18, 51}).isHashValid()).isFalse();

        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36, 10, 11}).isHashValid()).isTrue();
        Assertions.assertThat(new StringHashWithSalt2Builder("92345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36, 9, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-69, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-60, 125, 101, -116, 8, -76, 112, 126, -74, -85, -30, -33, -98, -35, -96, -36, 10, 11}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-68, 111, 97, -112, 0, 111, 6, 52, 103, 72, -78, 125, -52, -94, -77, 109, 10, 11}).isHashValid()).isTrue();
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{109, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-68, 111, 97, -112, 0, 111, 6, 52, 103, 72, -78, 125, -52, -94, -77, 109, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 100, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-68, 111, 97, -112, 0, 111, 6, 52, 103, 72, -78, 125, -52, -94, -77, 109, 10, 11}).isHashValid()).isFalse();
        ...
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{109, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.FIXED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-56, -54, 43, 102, 27, -32, 7, 57, -124, -58, 61, -25, -58, 60, 18, 51, 10, 11}).isHashValid()).isFalse();
        Assertions.assertThat(new StringHashWithSalt2Builder("12345", "UTF-8").setStoredSaltLenght(2).setFixedSalt(new byte[]{100, 101, 102}).setAlgorithm(HashAlgorithms.MD5).setSaltOrder(SaltOrder.STORED_SALT_FIRST).setSaltStoreType(SaltStoreType.AT_THE_END).setStoredHash(new byte[]{-56, -54, 43, 102, 27, -32, 7, 57, -124, -58, 61, -25, -58, 60, 18, 51, 10, 11}).isHashValid()).isFalse();
