...
final class StringHashWithSalt2Builder extends HashWithSalt2Builder {
    ...
    StringHashWithSalt2Builder(final String str, final String encoding) {
        super();
        _str = str;
        _encoding = encoding;
    }
    ...
    public boolean isHashValid() {
        if (getSaltStoreType() == SaltStoreType.DO_NOT_STORE) {
            ...
            return addSalt(HashHelper.getHash(_str, _encoding, getAlgorithm()), storedSalt).matches(storedHash);
        }
    }
